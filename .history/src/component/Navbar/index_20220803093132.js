        ...
        <div className="nav-container">
          ...
          <div className="nav-icon" onClick={handleClick}>
            {!click ? (
              <span
                className={
                  "lg:opacity-0 lg:invisible visible opacity-100  bg-white w-[40px] h-[40px] rounded-full flex justify-center cursor-pointer items-center text-white dark:text-white text-3xl ml-3 "
                }
              >
                <svg
                  stroke="currentColor"
