  ...
  return (
    <div className="p-4">
      ...
      <nav className="navbar" onClick={(e) => e.stopPropagation()}>
        ...
        >
          <img
            style="display: block;-webkit-user-select: none;margin: auto;cursor: zoom-in;background-color: hwb(0deg 62% 38% / 27%);transition: background-color 300ms;border-radius: 15px;"
