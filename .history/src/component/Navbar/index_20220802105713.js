...
const Navbar = () => {
  ...
  return (
        ...
        <div className="nav-container">
          <ul className={click ? "nav-menu active" : "nav-menu"}>
            <li className="nav-item">
              <span className="text-white mt-3 md:hidden lg:flex">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
            ...
            <li className="nav-item">
              <span className="text-white mt-3 flex md:hidden lg:flex">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
    ...
    //   <div
    //     className={
    //       "justify-between items-center fixed top-0 left-0 lg:static z-[1111111111] bg-black"
    //     }
    //   />
    //   <div
    ...
    //         click
    //           ? "nav-menu active"
    //           : "flex justify-between items-center bg-black nav-menu"
    //       }
    //     >
    //
    ...
    //       <div className="nav-icon" onClick={handleClick}>ssss
