    ...
    <div className="p-4">
      ...
      <nav className="navbar" onClick={(e) => e.stopPropagation()}>
        ...
        >
          <img
            className="logo"
            src="https://logos-download.com/wp-content/uploads/2021/01/Portfolio_Plus_Banking_Software_Logo-2048x455.png"
            width="150"
            height="50"
          />
        </NavLink>
        <div className="nav-container">
          ...
          <div className="nav-icon" onClick={handleClick}>
            {!click ? (
              <span
                className={
                  "lg:opacity-0 lg:invisible visible opacity-100  bg-white text-black w-[40px] h-[40px] rounded-full flex justify-center cursor-pointer items-center text-white dark:text-white text-3xl ml-3 "
                }
              >
                <svg
                  stroke="currentColor"
