      ...
      <div className="social-container flex grid-rows-1">
        <div className="flex grid-cols-2 social-link w-full  max-h-[50px] mt-5 ml-6">
          ...
          >
            ...
            <span className="origin-left text-black App-logo ml-2 hidden text-[25px] items-end text-end justify-items-end rounded-r-full p-2 w-[350px] font-bold bg-white">
              Salah Eddine <>Mdouka</>
            </span>
          </a>
        </div>
