    ...
    <>
      <section className="text-center text-black">
        ...
        <div className="social-container  justify-center lg:pl-[150px] space-y-[100px] mt-6">
          <div className="flex lg:grid-cols-2 sm:md:grid-cols-1 social-link max-h-[50px]">
            <a
              href="https://web.facebook.com/salaheddine.mdouka"
              className="facebook social relative lg:left-2 -mt-4 rounded-full border-[10px] border-white h-[82px]"
            >
              <FontAwesomeIcon icon={faFacebook} size="4x" />
            </a>
            <span className="text-black text-[25px] lg:p-5 w-full lg:-mx-2 lg:-my-2 lg:mr-[110px] rounded-r-full font-bold bg-white">
              Salah Eddine Mdouka
            </span>
          </div>
