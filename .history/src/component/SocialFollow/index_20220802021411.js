...
const SocialFollow = () => {
  return (
    <>
      ...
      <div className="social-container grid-cols-1 space-y-[50px]  m-2">
        <div className="flex grid-cols-2 social-link w-full space-x-2 max-h-[50px] mt-5 ml-6">
          <a
        ...
        <div className="flex grid-cols-2 social-link w-full space-x-3  max-h-[50px] mt-5 ml-6">
          <a
            href="https://www.facebook.com/learnbuildteach/"
            className="facebook social relative left-2 -mt-4 rounded-full border-[10px] border-white h-[82px]"
          >
