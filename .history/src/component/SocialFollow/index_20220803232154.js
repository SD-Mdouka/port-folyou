        ...
        <div className="social-container  justify-center pl-[150px] space-y-[100px] mt-6">
          <div className="flex grid-cols-2 social-link max-h-[50px]">
            <a
              ...
              className="facebook social relative left-2 -mt-4 rounded-full border-[10px] border-white h-[70px]"
            >
              <FontAwesomeIcon icon={faFacebook} size="3x" />
            </a>
            <span className="text-black text-[20px] p-3 w-full -mx-2 -my-2 mr-[110px] rounded-r-full font-bold bg-white">
              Salah Eddine Mdouka
            </span>
          </div>
          <div className="flex grid-cols-2 social-link max-h-[50px]">
