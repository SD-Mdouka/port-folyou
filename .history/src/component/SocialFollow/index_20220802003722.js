    ...
    <>
      ...
      <div className="social-container flex grid-rows-1">
        <div className="flex grid-cols-2 w-full  max-h-[50px] mt-5 ml-6">
          ...
          <span className="text-black animation-[wiggle_1s_ease-in-out_infinite] text-[25px] items-end text-end justify-items-end rounded-r-full p-2 w-[350px] font-bold bg-white">
            Salah Eddine Mdouka
          </span>
        </div>
      </div>
