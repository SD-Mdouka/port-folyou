  ...
  return (
    <>
      ...
      <div className="social-container grid-cols-1 space-y-[100px] mt-6">
        <div className="flex grid-cols-2 social-link max-h-[50px] mt-5">
          <a
            href="https://www.facebook.com/learnbuildteach/"
            className="facebook social relative left-2 rounded-full border-[10px] border-white h-[82px]"
          >
            <FontAwesomeIcon icon={faFacebook} size="4x" />
          </a>
          <span className="text-black text-[25px]  rounded-r-full font-bold bg-white">
            Salah Eddine Mdouka
          </span>
        </div>
        <div className="flex grid-cols-2 social-link max-h-[50px] mt-5">
