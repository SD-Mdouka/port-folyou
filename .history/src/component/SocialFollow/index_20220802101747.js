  ...
  return (
    <>
      ...
      <div className="social-container grid-cols-1 space-y-[100px] mt-6 ml-[420px]">
        <div className="flex grid-cols-2 social-link w-full max-h-[50px] mt-5 ml-[50px]">
          <a
        ...
        <div className="flex grid-cols-2 social-link w-full  max-h-[50px] mt-5 ml-[60px]">
          <a
            href="https://www.facebook.com/learnbuildteach/"
            className="facebook social relative left-2 -mt-4 rounded-full border-[10px] border-white h-[82px]"
          >
        ...
        <div className="flex grid-cols-2 social-link w-full  max-h-[50px] mt-5 ml-[70px]">
          <a
            href="https://www.facebook.com/learnbuildteach/"
            className="facebook social relative left-2 -mt-4 rounded-full border-[10px] border-white h-[82px]"
          >
