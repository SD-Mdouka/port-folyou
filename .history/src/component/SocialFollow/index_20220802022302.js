...
const SocialFollow = () => {
  return (
    <>
      <h3 className="justify-center items-center text-white font-bold text-2xl ml-[800px]">
        Social Follow
      </h3>
      <div className="social-container grid-cols-1 space-y-[100px] mt-6 ml-[500px]">
        ...
        <div className="flex grid-cols-2 social-link w-full  max-h-[50px] mt-5 ml-[230px]">
          <a
            href="https://www.facebook.com/learnbuildteach/"
            className="facebook social relative left-2 -mt-4 rounded-full border-[10px] border-white h-[82px]"
          >
