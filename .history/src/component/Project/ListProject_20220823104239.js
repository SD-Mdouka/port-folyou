            ...
            (project) =>
              tab === project.title && (
                <a
                  href={project.link}
                  key={project.image}
                  className="sm:w-1/2 w-full hover:rounded-lg hover:border hover:border-[#212425] transition-all p-2 duration-500  bg-transparent"
                >
                  <div className="flex relative">
                    <img
                      ...
                      src={project.image}
                    />
                    <div className="p-[24px] relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
