              ...
              tab === project.title && (
                ...
                >
                  <a
                    href={project.link}
                    key={project.image}
                    className="sm:w-1/2 w-full gap-8 justify-between hover:rounded-lg hover:border hover:border-[#212425] transition-all duration-500  bg-transparent"
                  >
                    <div className="flex relative">
                      <img
                        alt="gallery"
                        className="absolute  w-full h-[270px] object-cover"
                        src={project.image}
                      />
