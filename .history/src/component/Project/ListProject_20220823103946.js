            ...
            (project) =>
              tab === project.title && (
                <a
                  href={project.link}
                  key={project.image}
                  className="sm:w-1/2 w-full hover:rounded-lg hover:border hover:border-[#212425] transition-all duration-500 p-1 bg-transparent"
                >
                  <div className="flex relative">
                    <img
                      ...
                      src={project.image}
                    />
                    <div className="px-[20px] py-8 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
