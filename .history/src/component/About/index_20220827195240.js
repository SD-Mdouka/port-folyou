          ...
          <div data-aos="fade" className="aos-init aos-animate bg-transparent">
            ...
            >
              ...
              <div className="py-4">
                ...
                <div className="xl:grid grid-cols-10 gap-10 pt-4 md:pt-[40px] items-center">
                  <div className="sm:flex col-span-3 md:col-span-1 sm:col-span-3 xs:col-span-5">
                    <motion.div
                  ...
                  <div className="sm:flex col-span-7 space-y-2.5">
