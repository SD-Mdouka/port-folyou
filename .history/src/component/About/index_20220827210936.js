          ...
          <div data-aos="fade" className="aos-init aos-animate bg-transparent">
            ...
            >
              ...
              <div className="py-4">
                ...
                <div className="grid xl:lg:grid-cols-10 xs:sm:grid-cols-6 md:grid-cols-5 gap-10 pt-4 md:pt-[40px] items-center">
                  <div className="xl:lg:col-span-3 md:col-span-2 xs:sm:col-span-3">
                    <motion.div
                  ...
                  <div className="xl:lg:col-span-7 md:col-span-3 xs:sm:col-span-3 space-y-2.5">
                    <div className="mr-16">
