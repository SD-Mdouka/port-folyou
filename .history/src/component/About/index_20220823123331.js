      ...
      <section className="bg-transparent text-black">
        <div className="container bg-transparent sm:px-5 md:px-10 lg:px-15">
          <div data-aos="fade" className="aos-init aos-animate bg-transparent">
              ...
              <div className="py-4">
                ...
                <div className="grid grid-cols-12 md:gap-10 pt-4 md:pt-[40px] items-center">
                  <div className="col-span-14 md:col-span-4">
                    <motion.div
                      className="box"
                      initial={{ x: 0, y: 0, opacity: 0, translate: 0.9 }}
                      animate={{ x: 10, y: 10, opacity: 1, translate: 1 }}
                      exit={{ x: 20, y: 20, opacity: 0, translate: 0.9 }}
                      transition={{
                        duration: 0.18,
                        ease: [0.12, 0.93, 0.66, 0.97],
                      }}
            ...
            <motion.div
              className="box"
              initial={{ x: 10, y: -20, opacity: 0, translate: 0.9 }}
              animate={{ x: -10, y: -10, opacity: 1, translate: 1 }}
              exit={{ x: 0, y: 0, opacity: 0, translate: 0.9 }}
              transition={{
                duration: 3.18,
                ease: [0.12, 0.93, 0.66, 0.97],
              }}
