          ...
          <div data-aos="fade" className="aos-init aos-animate bg-transparent">
            ...
            >
              ...
              <div className="py-4">
                ...
                <div className="grid lg:grid-cols-10 xl:grid-cols-4  md:gap-10 pt-4 md:pt-[40px] items-center">
                  <div className="col-span-3 xl:col-span-2 sm:col-span-2">
                    <motion.div
                  ...
                  <div className="col-span-7 xl:col-span-2 md:col-span-8 space-y-2.5">
            ...
            >
              <div className="pt-10 pl-3">
                ...
                <div className="grid gap-8 lg:grid-cols-3 xl:grid-cols-1 md:grid-cols-2">
                  <div
