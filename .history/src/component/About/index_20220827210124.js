          ...
          <div data-aos="fade" className="aos-init aos-animate bg-transparent">
            ...
            >
              ...
              <div className="py-4">
                ...
                <div className="grid grid-cols-10 md:sm:grid-cols-6 gap-10 pt-4 md:pt-[40px] items-center">
                  <div className="lg:col-span-3 md:sm:col-span-3">
                    <motion.div
                  ...
                  <div className="lg:col-span-7 md:sm:col-span-3 space-y-2.5">
                    <div className="mr-16">
