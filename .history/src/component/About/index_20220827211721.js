          ...
          <div data-aos="fade" className="aos-init aos-animate bg-transparent">
            ...
            >
              ...
              <div className="py-4">
                ...
                <div className="grid xl:grid-cols-12 lg:grid-cols-10 xs:sm:grid-cols-2 md:grid-cols-5 gap-10 pt-4 md:pt-[40px] items-center">
                  <div className="xl:col-span-4 lg:col-span-3 md:col-span-2 xs:sm:col-span-2">
                    <motion.div
                  ...
                  <div className="xl:col-span-8 md:col-span-3 xs:sm:col-span-2 space-y-2.5">
                    <div className="mr-16">
            ...
            >
              <div className="pt-10 pl-3">
                ...
                <div className="grid gap-8 grid-cols-3 md:grid-cols-2 xl:grid-cols-3">
                  <div
