              ...
              <div className="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
                <div
                  className="transition-all duration-300
                   hover:box-border hover:md:box-content hover:text-white hover:p-5 rounded-[10px] hover:bg-black hover:shadow-lg
                ...
                <div
                  className="transition-all duration-300
                   hover:box-border hover:md:box-content hover:text-white hover:p-5 lg:rounded-[40px] hover:bg-black hover:shadow-lg
                    hover:shadow-blue-500/50 bg-transparent"
                >
                  <span className="w-10 h-10 object-contain block">
                    <FontAwesomeIcon
