          ...
          <div data-aos="fade" className="aos-init aos-animate bg-transparent">
            ...
            >
              ...
              <div className="py-4">
                ...
                <div className="xl:grid grid-cols-10 sm:flex gap-10 pt-4 md:pt-[40px] items-center">
                  <div className="col-span-3 md:col-span-1 sm:col-span-3 xs:col-span-5">
                    <motion.div
                  ...
                  <div className="col-span-7 md:col-span-9 sm:col-span-3 xs:col-span-5 space-y-2.5">
                    <div className=" md:mr-12 mr-16">
