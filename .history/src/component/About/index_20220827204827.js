          ...
          <div data-aos="fade" className="aos-init aos-animate bg-transparent">
            ...
            >
              ...
              <div className="py-4">
                ...
                <div className="sm:w-1/2 grid lg:grid-cols-10 sm:grid-rows-10 gap-10 pt-4 md:pt-[40px] items-center">
                  <div className="lg:col-span-3 sm:col-rows-3">
                    <motion.div
                  ...
                  <div className="lg:col-span-7 sm:col-rows-3 space-y-2.5">
                    <div className="mr-16">
