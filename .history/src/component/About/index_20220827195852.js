          ...
          <div data-aos="fade" className="aos-init aos-animate bg-transparent">
            ...
            >
              ...
              <div className="py-4">
                ...
                <div className="xl:grid xl:grid-cols-10 gap-10 pt-4 md:pt-[40px] items-center">
                  ...
                  <div className="sm:flex xl:col-span-7 space-y-2.5">
                    <div className="mr-16">
                    ...
                    <div className="">
                      ...
                      <div className="sm:flex xl:grid xl:grid-cols-2 gap-6">
                        <div className="flex">
